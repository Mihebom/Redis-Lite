...
public class ForTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.print(forTest.deserializer(new ByteArrayInputStream("*2\r\n+OK\r\n-ERR bad\r\n".getBytes(StandardCharsets.UTF_8))));

//        System.out.print(Arrays.toString(forTest.serializer("Echo \"World\"")));


//        System.out.print(forTest.deserializer(forTest.serializer("ECHO \"Hello World\"")));
    ...
    public String deserializer(InputStream in) throws IOException {
        ...
        if (type == '+') {
            ...
            throw new IOException("Err no valid type given");
        }
...
//
//            if ((readByte == '\n')) {
//                deserializedResponse.append("ERR '\\n' or '\\r' cannot exist in message");
//            }
//                deserializedResponse.append((char) readByte);
//        }
//
...
//
//            if ((readByte == -1)) {
//                throw new IOException("ERR no terminator");
//            }
//
//            if ((readByte == '\n')) {
//                throw new IOException("ERR incorrect termination command");
